  ...
  r("cells()", function (g, e, m) {
    ...
    (V.defaults = {
      ...
      oLanguage: {
        ...
        entries: { _: "записей", 1: "запись" },
        lengthLabels: { "-1": "All" },
        sEmptyTable: "Нет данных в таблице",
        sInfo: "Показано с _START_ по _END_ из _TOTAL_ _ENTRIES-TOTAL_",
        sInfoEmpty: "Показано с 0 по 0 из 0 _ENTRIES-TOTAL_",
        sInfoFiltered: "(отфильтровано _MAX_ _ENTRIES-MAX_)",
        sInfoPostFix: "",
        sDecimal: "",
        sThousands: ",",
        ...
        function (e, t) {
          ...
          return (
            ...
            "type" === t
              ...
              : ((e =
                  null === a
                    ? Nt(n, "toDate", "toJSDate", "")[s](navigator.language, {
                        timeZone: "UTC",
                      })
